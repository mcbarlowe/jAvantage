...
public class MINUS_DI extends apiConnector {
     ...
     */
    public MINUS_DI(String symbol, String interval, int time_period, String series_type, String apikey) {
    ...
    public static void main(String[] args) {
        MINUS_DI MINUS_DIDaily = new MINUS_DI("MSFT", "5min", 100, "close", "BKWGHZ46RDAVZQOK");
