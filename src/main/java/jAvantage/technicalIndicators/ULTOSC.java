...
public class ULTOSC extends apiConnector {
     ...
     *                    timeperiod3 is currently not working in the API will uncomment when it is back in service
     *                    API call will use the default value of timeperiod3 which is 28.
     */
    public ULTOSC(String symbol, String interval, String apikey, Integer... period) {
        ...
        if (period.length == 2) {
            ...
            throw new ArrayIndexOutOfBoundsException("\nYou passed " + period.length + " arguments to the ULTOSC API call and it needs five.\n" +
    ...
    public static void main(String[] args) {
        ULTOSC ULTOSCDaily = new ULTOSC("MSFT", "5min", "BKWGHZ46RDAVZQOK",  null, null);
